...
def train(args):
    ...
    if args.algorithm == 'dqn':
        ...
        agent = NFSPAgent(num_actions=env.num_actions,
                          ...
                          q_mlp_layers=[64, 64],
                          device=device)
    elif args.algorithm == 'dqnv2':
        from rlcard.agents import DQNAgent_v2
        agent = DQNAgent_v2(num_actions=env.num_actions,
                            state_shape=env.state_shape[0],
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algorithm', type=str, default='dqnv2', choices=['dqn', 'nfsp', 'dqnv2', 'dqnv3'])
    parser.add_argument('--cuda', type=str, default='')
    parser.add_argument('--seed', type=int, default=42)
    parser.add_argument('--num_episodes', type=int, default=10000)
    parser.add_argument('--num_games', type=int, default=2000)
    parser.add_argument('--evaluate_every', type=int, default=100)
    parser.add_argument('--log_dir', type=str, default='experiments/blackjack_dqnv2_result_4/')
